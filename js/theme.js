...
jQuery(document).ready(function( $ ) {
    ...
    if(!(/Android|iPhone|iPad|iPod|BlackBerry|Windows Phone/i).test(navigator.userAgent || navigator.vendor || window.opera)){
        ...
        $('.section-fullheight').removeClass('section-fullheight').css('min-height', $(window).height());
    }
    ...
    $('.magnific-audio').each(function(index , value){
        ...
        audio.magnificPopup({
            ...
            callbacks: {
                open: function() {
                    $(this.currItem.inlineElement).audioPlayer();
                }
            },
            closeBtnInside: true
        });
    ...
    $('.section-background-video, audio').mediaelementplayer({
        ...
        success: function(mediaElement) {
            ...
            var playerHeight = mediaElement.clientHeight;

            $(mediaElement).css('margin-top', containerHeight / 2 - playerHeight / 2 );
            $section.find('.mejs-overlay-loading').css('margin-top', containerHeight / 2 - playerHeight / 2);
        }
    });
    ...
    $('.navbar a, a.scroll-to-id').on('click', function(e) {
        ...
        var offset = scriptData.navbarHeight;
    ...
    if($scrollContainer.length > 0){
        $scrollContainer.infinitescroll({
            ...
            function( newElements ) {
                ...
                $scrollContainer.isotope( 'appended', $( newElements ), function(){
